              ...
              >
                <div class="form-floating mb-1">
                  ...
                  <label for="floatingInput"
                    ><span class="text-danger fs-7">*</span> 預約人姓名 :</label
                  >
                ...
                <div class="form-floating mb-1">
                  ...
                  <label for="floatingPassword"
                    ><span class="text-danger fs-7">*</span> 電話 :</label
                  >
                ...
                <div class="form-floating">
                  ...
                  />
                  <label for="floatingPassword"
                    ><span class="text-danger fs-7">*</span> 電子信箱 :</label
                  >
                ...
                <div class="form-floating mb-10">
                  ...
                  />
                  <label for="floatingPassword"
                    ><span class="text-danger fs-7">*</span> 預約人聯絡地址 :</label
                  >
                  <VError
                    name="預約人聯絡地址"
                ...
                <VField name="備註留言" v-slot="{ field, errors: fieldErrors }" rules="max:1000">
                  ...
                  ></textarea>
                  <div v-if="fieldErrors[0]" class="text-danger fs-7 mb-10">
                    {{ fieldErrors[0] }}
                  </div>
                </VField>
                <div class="mb-8 form-check">
                  <div class="d-flex justify-content-between align-items-bottom">
                    ...
                    <p class="fs-7 mt-2"><span class="text-danger fs-7">*</span> 號為必填選項</p>
                  </div>
                  <VError
                    name="check"
